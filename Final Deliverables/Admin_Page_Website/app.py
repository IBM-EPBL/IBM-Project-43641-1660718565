...
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=ea286ace-86c7-4d5b-8580-3fbfa46b1c66.bs2io90l08kqb1od8lcg.databases.appdomain.cloud; PORT=31505; SECURITY=SSL; SSLServerCertificate=DigiCertGlobalRootCA.crt; UID=hmg38167; PWD=C7o4DqgC1x7V3n0Z",'','')
...
app.config['MYSQL_PASSWORD'] = '__bala__32__'
...
def send_mail(email):
    print(email)
    message = Mail(from_email='bala34510@gmail.com',
                   to_emails=email,
                   subject='Warning',
                   html_content='<strong>You have entered a containment zone. Please approach safety as soon as possible</strong><img src= "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmjYta_0j7SzJFylnDT0RWiELr1kI921lwtBw_L-gkubYq8mqJy4nS7WPpyt_WWg_KL5A&usqp=CAU" alt="warning">')

    try:
        sg = sendgrid.SendGridAPIClient(
            api_key='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')
